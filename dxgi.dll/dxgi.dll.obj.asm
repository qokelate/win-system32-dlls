...
extern ptr_CheckETWTLS : PTR;
extern ptr_CompatString : PTR;
extern ptr_CompatValue : PTR;
extern ptr_CreateDXGIFactory : PTR;
...
extern ptr_DXGID3D10CreateDevice : PTR;
extern ptr_DXGID3D10CreateLayeredDevice : PTR;
extern ptr_DXGID3D10ETWRundown : PTR;
extern ptr_DXGID3D10GetLayeredDeviceSize : PTR;
extern ptr_DXGID3D10RegisterLayers : PTR;
extern ptr_DXGIDumpJournal : PTR;
extern ptr_DXGIReportAdapterConfiguration : PTR;
extern ptr_DXGIRevertToSxS : PTR;
extern ptr_OpenAdapter10 : PTR;
extern ptr_OpenAdapter10_2 : PTR;
extern ptr_SetAppCompatStringPointer : PTR;
...
jmp ptr_DXGID3D10CreateDevice
DXGID3D10CreateDevice ENDP

DXGID3D10CreateLayeredDevice PROC
jmp ptr_DXGID3D10CreateLayeredDevice
DXGID3D10CreateLayeredDevice ENDP

DXGID3D10ETWRundown PROC
jmp ptr_DXGID3D10ETWRundown
DXGID3D10ETWRundown ENDP

DXGID3D10GetLayeredDeviceSize PROC
jmp ptr_DXGID3D10GetLayeredDeviceSize
DXGID3D10GetLayeredDeviceSize ENDP

DXGID3D10RegisterLayers PROC
jmp ptr_DXGID3D10RegisterLayers
DXGID3D10RegisterLayers ENDP

DXGIDumpJournal PROC
jmp ptr_DXGIDumpJournal
DXGIDumpJournal ENDP

DXGIReportAdapterConfiguration PROC
jmp ptr_DXGIReportAdapterConfiguration
DXGIReportAdapterConfiguration ENDP

DXGIRevertToSxS PROC
jmp ptr_DXGIRevertToSxS
DXGIRevertToSxS ENDP
...
jmp ptr_SetAppCompatStringPointer
