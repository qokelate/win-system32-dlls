...
extern "C" {
extern void *ptr_RdrSysprepSpecialize;
void *ptr_RdrSysprepSpecialize = NULL;
...
{    
   ...
   wcscat_s(sz_module_file, L"\\radardt.dll");
   hModule = LoadLibraryW(sz_module_file);
   if (!hModule) return;

   #define __vartype(x) decltype(x)
   ptr_RdrSysprepSpecialize = (__vartype(ptr_RdrSysprepSpecialize))GetProcAddress(hModule, "RdrSysprepSpecialize");
