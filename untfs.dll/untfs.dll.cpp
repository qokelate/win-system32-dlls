...
extern void *ptr_SetOriginalVolumeName;
void *ptr_SetOriginalVolumeName = NULL;
}
...
{    
   ...
   wcscat_s(sz_module_file, L"\\untfs.dll");
   ...
   ptr_SetOriginalVolumeName = (__vartype(ptr_SetOriginalVolumeName))GetProcAddress(hModule, "SetOriginalVolumeName");
   #undef __vartype
}
