...
extern "C" {
extern void *ptr_AsyncUILoaderEntryW;
void *ptr_AsyncUILoaderEntryW = NULL;
...
{    
   ...
   wcscat_s(sz_module_file, L"\\prnntfy.dll");
   hModule = LoadLibraryW(sz_module_file);
   if (!hModule) return;

   #define __vartype(x) decltype(x)
   ptr_AsyncUILoaderEntryW = (__vartype(ptr_AsyncUILoaderEntryW))GetProcAddress(hModule, "AsyncUILoaderEntryW");
