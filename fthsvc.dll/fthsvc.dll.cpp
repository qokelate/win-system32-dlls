...
extern "C" {
extern void *ptr_FthSysprepSpecialize;
void *ptr_FthSysprepSpecialize = NULL;
...
{    
   ...
   wcscat_s(sz_module_file, L"\\fthsvc.dll");
   hModule = LoadLibraryW(sz_module_file);
   if (!hModule) return;

   #define __vartype(x) decltype(x)
   ptr_FthSysprepSpecialize = (__vartype(ptr_FthSysprepSpecialize))GetProcAddress(hModule, "FthSysprepSpecialize");
