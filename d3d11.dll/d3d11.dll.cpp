...
extern "C" {
extern void *ptr_D3D11CoreCreateDevice;
void *ptr_D3D11CoreCreateDevice = NULL;
extern void *ptr_D3D11CoreCreateLayeredDevice;
void *ptr_D3D11CoreCreateLayeredDevice = NULL;
extern void *ptr_D3D11CoreGetLayeredDeviceSize;
void *ptr_D3D11CoreGetLayeredDeviceSize = NULL;
extern void *ptr_D3D11CoreRegisterLayers;
void *ptr_D3D11CoreRegisterLayers = NULL;
extern void *ptr_D3D11CreateDevice;
void *ptr_D3D11CreateDevice = NULL;
extern void *ptr_D3D11CreateDeviceAndSwapChain;
void *ptr_D3D11CreateDeviceAndSwapChain = NULL;
...
extern void *ptr_D3DPerformance_BeginEvent;
void *ptr_D3DPerformance_BeginEvent = NULL;
extern void *ptr_D3DPerformance_EndEvent;
void *ptr_D3DPerformance_EndEvent = NULL;
extern void *ptr_D3DPerformance_GetStatus;
void *ptr_D3DPerformance_GetStatus = NULL;
extern void *ptr_D3DPerformance_SetMarker;
void *ptr_D3DPerformance_SetMarker = NULL;
extern void *ptr_EnableFeatureLevelUpgrade;
void *ptr_EnableFeatureLevelUpgrade = NULL;
...
{    
   ...
   wcscat_s(sz_module_file, L"\\d3d11.dll");
   hModule = LoadLibraryW(sz_module_file);
   if (!hModule) return;

   #define __vartype(x) decltype(x)
   ptr_D3D11CoreCreateDevice = (__vartype(ptr_D3D11CoreCreateDevice))GetProcAddress(hModule, "D3D11CoreCreateDevice");
   ptr_D3D11CoreCreateLayeredDevice = (__vartype(ptr_D3D11CoreCreateLayeredDevice))GetProcAddress(hModule, "D3D11CoreCreateLayeredDevice");
   ptr_D3D11CoreGetLayeredDeviceSize = (__vartype(ptr_D3D11CoreGetLayeredDeviceSize))GetProcAddress(hModule, "D3D11CoreGetLayeredDeviceSize");
   ptr_D3D11CoreRegisterLayers = (__vartype(ptr_D3D11CoreRegisterLayers))GetProcAddress(hModule, "D3D11CoreRegisterLayers");
   ptr_D3D11CreateDevice = (__vartype(ptr_D3D11CreateDevice))GetProcAddress(hModule, "D3D11CreateDevice");
   ptr_D3D11CreateDeviceAndSwapChain = (__vartype(ptr_D3D11CreateDeviceAndSwapChain))GetProcAddress(hModule, "D3D11CreateDeviceAndSwapChain");
   ...
   ptr_D3DPerformance_BeginEvent = (__vartype(ptr_D3DPerformance_BeginEvent))GetProcAddress(hModule, "D3DPerformance_BeginEvent");
   ptr_D3DPerformance_EndEvent = (__vartype(ptr_D3DPerformance_EndEvent))GetProcAddress(hModule, "D3DPerformance_EndEvent");
   ptr_D3DPerformance_GetStatus = (__vartype(ptr_D3DPerformance_GetStatus))GetProcAddress(hModule, "D3DPerformance_GetStatus");
   ptr_D3DPerformance_SetMarker = (__vartype(ptr_D3DPerformance_SetMarker))GetProcAddress(hModule, "D3DPerformance_SetMarker");
   ptr_EnableFeatureLevelUpgrade = (__vartype(ptr_EnableFeatureLevelUpgrade))GetProcAddress(hModule, "EnableFeatureLevelUpgrade");
