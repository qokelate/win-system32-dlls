...
extern "C" {
extern void *ptr_HelperTraceEvent;
void *ptr_HelperTraceEvent = NULL;
...
{    
   ...
   ptr_HelperTraceEvent = (__vartype(ptr_HelperTraceEvent))GetProcAddress(hModule, "HelperTraceEvent");
