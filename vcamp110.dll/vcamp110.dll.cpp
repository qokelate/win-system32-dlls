...
extern void *ptr___dpc_set_device_buffer_info;
void *ptr___dpc_set_device_buffer_info = NULL;
...
{    
   ...
   wcscat_s(sz_module_file, L"\\vcamp110.dll");
   ...
   ptr___dpc_set_device_buffer_info = (__vartype(ptr___dpc_set_device_buffer_info))GetProcAddress(hModule, "__dpc_set_device_buffer_info");
