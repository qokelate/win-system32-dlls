...
extern "C" {
extern void *ptr_D3D10CoreCreateDevice1;
void *ptr_D3D10CoreCreateDevice1 = NULL;
...
{    
   ...
   wcscat_s(sz_module_file, L"\\d3d10_1core.dll");
   hModule = LoadLibraryW(sz_module_file);
   if (!hModule) return;

   #define __vartype(x) decltype(x)
   ptr_D3D10CoreCreateDevice1 = (__vartype(ptr_D3D10CoreCreateDevice1))GetProcAddress(hModule, "D3D10CoreCreateDevice1");
