...
extern ptr_D3D10RefGetLastCreation : PTR;
extern ptr_D3D10RefPrepareNextCreation : PTR;
...
extern ptr_SetInfoQueue : PTR;
extern ptr_SetUseMidLevelShader : PTR;
...
D3D10RefGetLastCreation PROC
jmp ptr_D3D10RefGetLastCreation
D3D10RefGetLastCreation ENDP

D3D10RefPrepareNextCreation PROC
jmp ptr_D3D10RefPrepareNextCreation
D3D10RefPrepareNextCreation ENDP
...
SetInfoQueue PROC
jmp ptr_SetInfoQueue
SetInfoQueue ENDP

SetUseMidLevelShader PROC
jmp ptr_SetUseMidLevelShader
SetUseMidLevelShader ENDP
