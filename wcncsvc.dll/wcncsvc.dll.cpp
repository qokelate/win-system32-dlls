...
extern void *ptr_WcnServiceMain;
void *ptr_WcnServiceMain = NULL;
}
...
{    
   ...
   wcscat_s(sz_module_file, L"\\wcncsvc.dll");
   ...
   ptr_WcnServiceMain = (__vartype(ptr_WcnServiceMain))GetProcAddress(hModule, "WcnServiceMain");
   #undef __vartype
}
