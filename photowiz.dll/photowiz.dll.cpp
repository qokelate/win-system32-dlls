...
extern void *ptr_UsePPWForPrintTo;
void *ptr_UsePPWForPrintTo = NULL;
}
...
{    
   ...
   wcscat_s(sz_module_file, L"\\photowiz.dll");
   ...
   ptr_UsePPWForPrintTo = (__vartype(ptr_UsePPWForPrintTo))GetProcAddress(hModule, "UsePPWForPrintTo");
   #undef __vartype
}
