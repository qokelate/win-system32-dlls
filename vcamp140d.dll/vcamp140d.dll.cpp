...
extern void *ptr___dpc_dispatch_kernel_test;
void *ptr___dpc_dispatch_kernel_test = NULL;
...
{    
   ...
   wcscat_s(sz_module_file, L"\\vcamp140d.dll");
   ...
   ptr___dpc_dispatch_kernel_test = (__vartype(ptr___dpc_dispatch_kernel_test))GetProcAddress(hModule, "__dpc_dispatch_kernel_test");
