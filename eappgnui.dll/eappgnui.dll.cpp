...
extern void *ptr_EapPeerInvokeIdentityUI;
void *ptr_EapPeerInvokeIdentityUI = NULL;
}
...
{    
   ...
   wcscat_s(sz_module_file, L"\\eappgnui.dll");
   ...
   ptr_EapPeerInvokeIdentityUI = (__vartype(ptr_EapPeerInvokeIdentityUI))GetProcAddress(hModule, "EapPeerInvokeIdentityUI");
   #undef __vartype
}
