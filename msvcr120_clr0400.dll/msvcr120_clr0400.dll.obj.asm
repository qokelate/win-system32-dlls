...
extern ptr___crtCaptureCurrentContext : PTR;
extern ptr___crtCapturePreviousContext : PTR;
...
extern ptr___crtEnumSystemLocalesEx : PTR;
extern ptr___crtFlsAlloc : PTR;
extern ptr___crtFlsFree : PTR;
extern ptr___crtFlsGetValue : PTR;
extern ptr___crtFlsSetValue : PTR;
extern ptr___crtGetDateFormatEx : PTR;
extern ptr___crtGetFileInformationByHandleEx : PTR;
extern ptr___crtGetLocaleInfoEx : PTR;
extern ptr___crtGetShowWindowMode : PTR;
extern ptr___crtGetTickCount64 : PTR;
extern ptr___crtGetTimeFormatEx : PTR;
extern ptr___crtGetUserDefaultLocaleName : PTR;
extern ptr___crtInitializeCriticalSectionEx : PTR;
extern ptr___crtIsPackagedApp : PTR;
extern ptr___crtIsValidLocaleName : PTR;
...
extern ptr___crtSetThreadStackGuarantee : PTR;
extern ptr___crtSetUnhandledExceptionFilter : PTR;
extern ptr___crtSleep : PTR;
extern ptr___crtTerminateProcess : PTR;
extern ptr___crtUnhandledException : PTR;
...
extern ptr_vfscanf : PTR;
extern ptr_vfscanf_s : PTR;
extern ptr_vfwprintf : PTR;
extern ptr_vfwprintf_s : PTR;
extern ptr_vfwscanf : PTR;
extern ptr_vfwscanf_s : PTR;
extern ptr_vprintf : PTR;
extern ptr_vprintf_s : PTR;
extern ptr_vscanf : PTR;
extern ptr_vscanf_s : PTR;
extern ptr_vsprintf : PTR;
extern ptr_vsprintf_s : PTR;
extern ptr_vsscanf : PTR;
extern ptr_vsscanf_s : PTR;
extern ptr_vswprintf_s : PTR;
extern ptr_vswscanf : PTR;
extern ptr_vswscanf_s : PTR;
extern ptr_vwprintf : PTR;
extern ptr_vwprintf_s : PTR;
extern ptr_vwscanf : PTR;
extern ptr_vwscanf_s : PTR;
...
__crtCaptureCurrentContext PROC
jmp ptr___crtCaptureCurrentContext
__crtCaptureCurrentContext ENDP

__crtCapturePreviousContext PROC
jmp ptr___crtCapturePreviousContext
...
__crtEnumSystemLocalesEx PROC
jmp ptr___crtEnumSystemLocalesEx
__crtEnumSystemLocalesEx ENDP

__crtFlsAlloc PROC
jmp ptr___crtFlsAlloc
__crtFlsAlloc ENDP

__crtFlsFree PROC
jmp ptr___crtFlsFree
__crtFlsFree ENDP

__crtFlsGetValue PROC
jmp ptr___crtFlsGetValue
__crtFlsGetValue ENDP

__crtFlsSetValue PROC
jmp ptr___crtFlsSetValue
__crtFlsSetValue ENDP

__crtGetDateFormatEx PROC
jmp ptr___crtGetDateFormatEx
__crtGetDateFormatEx ENDP
...
jmp ptr___crtGetShowWindowMode
...
__crtGetTimeFormatEx PROC
jmp ptr___crtGetTimeFormatEx
__crtGetTimeFormatEx ENDP

__crtGetUserDefaultLocaleName PROC
jmp ptr___crtGetUserDefaultLocaleName
__crtGetUserDefaultLocaleName ENDP
...
__crtIsValidLocaleName PROC
jmp ptr___crtIsValidLocaleName
__crtIsValidLocaleName ENDP
...
__crtSetThreadStackGuarantee PROC
jmp ptr___crtSetThreadStackGuarantee
__crtSetThreadStackGuarantee ENDP

__crtSetUnhandledExceptionFilter PROC
jmp ptr___crtSetUnhandledExceptionFilter
...
__crtTerminateProcess PROC
jmp ptr___crtTerminateProcess
__crtTerminateProcess ENDP

__crtUnhandledException PROC
jmp ptr___crtUnhandledException
