...
extern void *ptr_D3D10CreateDevice;
void *ptr_D3D10CreateDevice = NULL;
extern void *ptr_D3D10CreateDeviceAndSwapChain;
void *ptr_D3D10CreateDeviceAndSwapChain = NULL;
...
{    
   ...
   wcscat_s(sz_module_file, L"\\d3d10.dll");
   ...
   ptr_D3D10CreateDevice = (__vartype(ptr_D3D10CreateDevice))GetProcAddress(hModule, "D3D10CreateDevice");
   ptr_D3D10CreateDeviceAndSwapChain = (__vartype(ptr_D3D10CreateDeviceAndSwapChain))GetProcAddress(hModule, "D3D10CreateDeviceAndSwapChain");
