...
extern void *ptr_WSHGetBroadcastSockaddr;
void *ptr_WSHGetBroadcastSockaddr = NULL;
...
{    
   ...
   wcscat_s(sz_module_file, L"\\wshbth.dll");
   ...
   ptr_WSHGetBroadcastSockaddr = (__vartype(ptr_WSHGetBroadcastSockaddr))GetProcAddress(hModule, "WSHGetBroadcastSockaddr");
